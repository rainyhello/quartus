...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone III" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
module  ip_convert2_altbarrel_shift_puf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //ip_convert2_altbarrel_shift_puf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  ip_convert2_altfp_convert_q2o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	ip_convert2_altbarrel_shift_puf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //ip_convert2_altfp_convert_q2o
//VALID FILE
...
module ip_convert2 (
	...
	ip_convert2_altfp_convert_q2o	ip_convert2_altfp_convert_q2o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
